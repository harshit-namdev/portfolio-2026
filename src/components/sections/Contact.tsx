            ...
            <section id="contact" ref={sectionRef} className="py-24 md:py-32 relative">
                ...
                <div className="max-w-6xl mx-auto px-6 relative z-10">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 contact-reveal">
                        ...
                        <MagneticButton>
                            <a href="/resume/Harshit-Namdev-Resume.pdf" target="_blank" rel="noopener noreferrer" className="group flex items-center justify-center gap-2 border border-accent text-accent px-10 py-4 rounded-full font-semibold hover:bg-accent-subtle transition-all duration-300">
